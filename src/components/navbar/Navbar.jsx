        ...
        <nav className="max-w-[1420px] mx-auto flex flex-wrap justify-between md:items-center text-black dark:text-white px-4 md:mt-[24px] mt-6 md:px-0">
            ...
            <ul
                className={`${menu ? "block" : "hidden"
                    }     mx-24 p-y2 mt-4 font-normal md:mt-5 bg-black px-2 rounded-xl bg-opacity-30 md:border-none text-center items-center md:bg-transparent md:static md:mx-0 md:flex gap-6 lg:text-[21px] text-lg`}
            >
                <a href="#home">
                ...
                <li className="">
                    <button className="lg:w-[188px] text-white rounded-[5px] h-[52px] px-2 py-2 bg-[#FD6F00]">
                        Download CV
                    </button>
                </li>
